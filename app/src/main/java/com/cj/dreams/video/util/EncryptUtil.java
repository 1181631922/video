...
public class EncryptUtil {
     ...
     * @return
     */
    public static String picEncryptBASE64(String str) {
        if (str == null || str.length() == 0) {
            return null;
        } else {
            byte[] encode = str.getBytes();
            // base64 加密
            return new String(Base64.encode(encode, 0, encode.length, Base64.DEFAULT));
        }
    }
     ...
     * @return
     */
    public static String picDecryptBASE64(String str) {
        if (str == null || str.length() == 0) {
            return null;
        } else {
            ...
            byte[] encode = str.getBytes();
            // base64 解密
            return new String(Base64.decode(encode, 0, encode.length, Base64.DEFAULT));
        }
