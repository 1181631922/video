 ...
 * </p>
 */
public class CopyEmailDialog extends Dialog implements View.OnClickListener {
    int layoutRes;
    Context context;
    ...
    public CopyEmailDialog(Context context) {
        super(context);
     ...
     * @param resLayout
     */
    public CopyEmailDialog(Context context, int resLayout) {
        super(context);
        this.context = context;
     ...
     * @param resLayout
     */
    public CopyEmailDialog(Context context, int theme, int resLayout) {
        super(context, theme);
        this.context = context;
        this.layoutRes = resLayout;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_exit_detail.setText("是否确定复制邮箱号到粘贴板");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.confirm_btn:
                FileManagerUtil.copy("cj_dreams@163.com", context);
                Message message=Message.obtain();
                message.what=0;
                handler.sendMessage(message);
                CopyEmailDialog.this.dismiss();
                break;
